...
class ProjectStateS9 extends StateS9<ProjectS9> {
...
const projectStateS9 = ProjectStateS9.getInstance();
...
abstract class ComponentS9<T extends HTMLElement, U extends HTMLElement> {
  ...
  implements DragTarget
{
  ...
  dropHandler(event: DragEvent): void {
    ...
    projectStateS9.moveProject(
      prjId,
      this.type === "active" ? ProjectStatusS9.Active : ProjectStatusS9.Finished
    );
  }
...
//ProjectInput Class
class ProjectInputS9 extends ComponentS9<HTMLDivElement, HTMLFormElement> {
...
const prjInputS9 = new ProjectInputS9();
const activePrjListS9 = new ProjectListS9("active");
const finishedPrjListS9 = new ProjectListS9("finished");
